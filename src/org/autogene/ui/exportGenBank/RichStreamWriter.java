 ...
 * particular format. This can be wired from a StreamReader to make a simple
 * file-format conversion utility, or can be used to write out the sequences in
 * a database to disk.
 * 
...
public class RichStreamWriter {
	 ...
	 * 
	 * @param ss
	 *            the SequenceIterator to loop over
	 * @throws IOException
