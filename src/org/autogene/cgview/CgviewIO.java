    ...
    /*private static void writeToSVGFile(Cgview cgview, String filename, boolean embedFonts, boolean useCompression, int nextZoomValue, boolean keepLastLabels) throws FileNotFoundException, IOException, UnsupportedEncodingException, SVGGraphics2DIOException {
		...
		if (nextZoomValue == -1) {
            ...
            if (useCompression) {
                ...
                graphics2D.stream(root, out, useCSS, true);
                out.flush();
                gzipOut.flush();
                out.close();
                gzipOut.close();
  ...
  /*  public static void writeToSVGFile(Cgview cgview, String filename, boolean embedFonts, boolean useCompression, boolean keepLastLabels) throws FileNotFoundException, IOException, UnsupportedEncodingException, SVGGraphics2DIOException {
	...
	if (inputValue.length() >= 3) {
		...
		System.exit(1);		
            ...
            if (formatValue.equalsIgnoreCase("png")) {
                try {
		...
		try {
			...
			if (!excludeSVGValue.booleanValue()) {
				...
				writeHTMLToFile(cgview, SVG_OUT_PATH + "/" + Integer.toString(imageToDraw.getZoomValue()) + "_" + Integer.toString(imageToDraw.getZoomCenter()) + "." + "svgz", "svgz", seriesValue + File.separator + "index_svg.html", null, null, null, null);
                        ...
                        if (k < zoomValues.length - 1) {
                            //png
                            writeHTMLToFile(cgview, PNG_OUT_PATH + "/" + Integer.toString(imageToDraw.getZoomValue()) + "_" + Integer.toString(imageToDraw.getZoomCenter()) + "." + "png", "png", seriesValue + File.separator + Integer.toString(imageToDraw.getZoomValue()) + "_" + Integer.toString(imageToDraw.getZoomCenter()) + "." + "html", imageToDraw.getZoomOutFilePrefix(toDrawPreviousZoom, zoomValues[k - 1]) + "." + "html", imageToDraw.getZoomInFilePrefix(labelBounds, zoomValues[k + 1]) + "." + "html", imageToDraw.getClockwiseFilePrefix(toDrawCurrentZoom) + "." + "html", imageToDraw.getCounterclockwiseFilePrefix(toDrawCurrentZoom) + "." + "html");

                            //svgz
			    if (!excludeSVGValue.booleanValue()) {
				writeHTMLToFile(cgview, SVG_OUT_PATH + "/" + Integer.toString(imageToDraw.getZoomValue()) + "_" + Integer.toString(imageToDraw.getZoomCenter()) + "." + "svgz", "svgz", seriesValue + File.separator + Integer.toString(imageToDraw.getZoomValue()) + "_" + Integer.toString(imageToDraw.getZoomCenter()) + "_svg." + "html", imageToDraw.getZoomOutFilePrefix(toDrawPreviousZoom, zoomValues[k - 1]) + "." + "html", imageToDraw.getZoomInFilePrefix(labelBounds, zoomValues[k + 1]) + "." + "html", imageToDraw.getClockwiseFilePrefix(toDrawCurrentZoom) + "." + "html", imageToDraw.getCounterclockwiseFilePrefix(toDrawCurrentZoom) + "." + "html");
			    }
                        ...
                        //this is the most zoomed in level
                            ...
                            //png
                            writeHTMLToFile(cgview, PNG_OUT_PATH + "/" + Integer.toString(imageToDraw.getZoomValue()) + "_" + Integer.toString(imageToDraw.getZoomCenter()) + "." + "png", "png", seriesValue + File.separator + Integer.toString(imageToDraw.getZoomValue()) + "_" + Integer.toString(imageToDraw.getZoomCenter()) + "." + "html", imageToDraw.getZoomOutFilePrefix(toDrawPreviousZoom, zoomValues[k - 1]) + "." + "html", null, imageToDraw.getClockwiseFilePrefix(toDrawCurrentZoom) + "." + "html", imageToDraw.getCounterclockwiseFilePrefix(toDrawCurrentZoom) + "." + "html");

                            //svgz
			    if (!excludeSVGValue.booleanValue()) {
				writeHTMLToFile(cgview, SVG_OUT_PATH + "/" + Integer.toString(imageToDraw.getZoomValue()) + "_" + Integer.toString(imageToDraw.getZoomCenter()) + "." + "svgz", "svgz", seriesValue + File.separator + Integer.toString(imageToDraw.getZoomValue()) + "_" + Integer.toString(imageToDraw.getZoomCenter()) + "_svg." + "html", imageToDraw.getZoomOutFilePrefix(toDrawPreviousZoom, zoomValues[k - 1]) + "." + "html", null, imageToDraw.getClockwiseFilePrefix(toDrawCurrentZoom) + "." + "html", imageToDraw.getCounterclockwiseFilePrefix(toDrawCurrentZoom) + "." + "html");
			    }
                        }
                    }
                }
